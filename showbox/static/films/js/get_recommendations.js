                ...
                let temp_str = `
                        <div class="position-relative">
                            ...
                            <div class="view overlay hoverable z-depth-1">
                                <a href='/showbox/detail/${req_type}/${items[key].id}' class="zoom text-decoration-none">
                                    ${backdrop_img}
                                </a>
                            </div>
                            <a href='/showbox/detail/${req_type}/${items[key].id}' class="zoom text-decoration-none">
                            ...
                            <a href='/showbox/detail/${req_type}/${items[key].id}' class="badge badge-primary">Read More</a>
                        </div>
                        `;
